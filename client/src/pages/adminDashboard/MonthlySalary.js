...
const SalaryDetails = () => {
  ...
  const monthlySalaryForm = adminPathDecider("monthlySalaryForm", userType);

  const salaryPdf = adminPathDecider("salaryPdf", userType);
  useEffect(() => {
    getDepartment(
      `/monthlySalary?page=${page}&sort=${sort}&salaryStatus=${salaryStatus}`
    );
    ...
    <>
      <div className="form-btn-container">
        <button className="btn">
          <Link to={monthlySalaryForm}>Add</Link>
        </button>
        <h5>
                ...
                <tr className="tr-body">
                  ...
                  >
                    ...
                    <FaTrashAlt
                      ...
                      onClick={() =>
                        openModal(_id, "monthlySalary", getDepartment)
                      }
                    />
                    <Link
                      to={salaryPdf}
